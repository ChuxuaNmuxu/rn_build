...
RUN echo y | sdkmanager --proxy='mirrors.neusoft.edu.cn' --proxy_host='80' --no_https "platform-tools" "build-tools;26.0.2" "build-tools;25.0.3" "platforms;android-26" "platforms;android-25" \
